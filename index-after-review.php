...
/*ВАЖНЫЙ МОМЕНТ
во время ревью я понял что у тебя StoreHandler и PasswordController выполняют очень похожие задачи, но ты их разделил
...
PasswordController - отвечает за бизнес логику (он оркестрирует классы, выводит список команд и обрабатывает их) (это много для одного класса, но чуть позже я расскажу как это красиво разобрать)
